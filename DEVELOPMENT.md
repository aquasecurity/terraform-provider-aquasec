...
```
mkdir -p examples/resources/.terraform/plugins/terraform-provider-aquasec/aquasec/aquasec/0.8.6/darwin_amd64/

mv terraform-provider-aquasec examples/resources/.terraform/plugins/terraform-provider-aquasec/aquasec/aquasec/0.8.6/darwin_amd64/terraform-provider-aquasec
```
Make sure to replace the version `0.8.6` and the architecture `darwin_amd64` in the path as relevant for your system.
