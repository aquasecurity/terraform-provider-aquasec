...
- `allowed_images` (List of Object) (see [below for nested schema](#nestedatt--allowed_images))
...
- `scap_files` (List of Object) (see [below for nested schema](#nestedatt--scap_files))
...
<a id="nestedatt--allowed_images"></a>
